...
- [ ] **Historia 1.6.1: Documentación e Implementación del SVS de ITIL 4 y Principios Guía** (Pts: 3) [David - Cloud Architect]
- [ ] **Historia 1.6.2: Definición de Procesos para Mesa de Servicios y Gestión de Incidentes** (Pts: 5) [David - DevOps]
- [ ] **Historia 1.6.3: Integración de Gestión de Problemas y Habilitación del Cambio en CI/CD** (Pts: 5) [David - DevOps]
