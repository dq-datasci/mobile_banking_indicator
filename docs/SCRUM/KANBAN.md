# Tablero Kanban Enterprise y Asignación de Sprints

> **Leyenda (Pts a Horas):** `3 Pts` (~4h), `5 Pts` (~8h), `8 Pts` (~16h/2 días).
...
- [x] **Historia 1.5.11: Búsqueda de IDs y Configuración de Extracción Masiva** (Pts: 5) [Antigravity - Data Engineer]
...
- [x] **Historia 2.3.1: Facade NLP y Clasificación de Sentimiento Básica** (Pts: 8) [David - Data Scientist]
- [x] **Historia 2.3.2: Extracción Temática y MLflow Tracking** (Pts: 5) [David - MLOps]
- [x] **Historia 2.3.3: LLM Inference Pipeline (PySpark UDFs & Asyncio)** (Pts: 8) [David - Data Engineer]
- [x] **Historia 2.3.4: Detección de Seguridad y Urgencia Triage (LangGraph)** (Pts: 8) [David - AI Engineer]
- [x] **Historia 2.3.5: Extracción de Causa Raíz y Auto-Respuesta (Community Manager Agent)** (Pts: 8) [David - AI Engineer]
...
## 🚀 RELEASE 2: B2B SaaS & Omnicanalidad
