...
class PlayStoreReviewContract(BaseModel):
    ...
    userImage: Optional[str] = Field(None, description="URL of the user's profile image")
    ...
    reviewCreatedVersion: Optional[str] = Field(None, description="App version when the review was created")
    at: datetime = Field(..., description="Timestamp of the review")
    replyContent: Optional[str] = Field(None, description="Content of the developer's reply")
    repliedAt: Optional[datetime] = Field(None, description="Timestamp of the developer's reply")
    appVersion: Optional[str] = Field(None, description="Current app version of the user")
